...
grid_search = pickle.load(open("viraj_model.pkl", "rb"))
...
with col1:
	...
	sc = st.radio("SeniorCitizen", ('Yes','No'))
...
if st.button("Predict Churners"):
	...
	input_data = np.array([[sc,tenure,mc,tc,1,osy,1,oby,1,dy,1,ty,iff,isn,1,sty,1,smy,c1,c2,pby,pay,1,1]])
	result = predict(input_data)
	st.write(result[0])

	
st.markdown("Developed By Viraj Vataria")